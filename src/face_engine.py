...
def _calibrated_cosine_to_similarity(distance: float) -> float:
    """
    Calibrated Cosine Similarity Curve:
...
def match_faces(id_card_path: str, live_photo_path: str) -> Dict[str, Any]:
    """
    Matches face on ID card against live capture photo with Anti-Spoofing & Latency Profiling.
    """
    ...
    try:
        ...
        # Handle skewed/tilted document alignment fallback
